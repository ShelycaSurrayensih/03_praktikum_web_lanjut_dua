...
<<<<<<< HEAD
                                ...
                                <div class="media tm-related-post">
                                  <div class="media-left media-middle">
                                    <a href="#">
                                      <img class="media-object" src="{{$item -> featured_image}}" alt="Generic placeholder image">
                                    </a>
                                  </div>
                                  <div class="media-body">
                                    <a href="#"><h4 class="media-heading tm-gold-text tm-margin-b-15">{{$item -> title}}</h4></a>
                                    <p class="tm-small-font tm-media-description">{{$item -> content}}</p>
                                  </div>
                                </div>
                                @endforeach
                                {{-- <div class="media tm-related-post">
